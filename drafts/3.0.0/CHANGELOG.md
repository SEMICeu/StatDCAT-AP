...
This changelog provides an overview of the changes incorporated in StatDCAT-AP 3.0.0. A complete list of the issues closed with this release is accessible on [GitHub](https://github.com/SEMICeu/StatDCAT-AP/issues?q=is%3Aissue+is%3Aclosed+label%3Arelease%3A3.0.0).

# **Editorial changes**
- Updated statdcatap prefix
- Added information on working groups
